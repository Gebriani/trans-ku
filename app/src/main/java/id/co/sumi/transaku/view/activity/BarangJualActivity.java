...
public class BarangJualActivity extends ParentActivity implements InventoryMvpView,
        InventoryBarangAdapter.inventoryBarangInterface, EditPriceDialog.DialogPriceInterface
        , SearchView.OnQueryTextListener{

    private Toolbar toolbarBarangJual;
    private TextView toolbarTitle;
    private RecyclerView rvBarangJual;
    private InventoryPresenter presenter;
    private InventoryBarangAdapter barangAdapter;
    ...
    private void findView(){
        toolbarBarangJual = (Toolbar) findViewById(R.id.toolbar);
        toolbarTitle = (TextView) findViewById(R.id.toolbar_title);
        rvBarangJual = (RecyclerView) findViewById(R.id.barangJual_recycleView);
        rvBarangJual.setLayoutManager(new LinearLayoutManager(rvBarangJual.getContext()));

        setSupportActionBar(toolbarBarangJual);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setHomeAsUpIndicator(R.mipmap.ic_arrow_left);
        getSupportActionBar().setTitle("");
        toolbarTitle.setText("BARANG JUAL");
        toolbarBarangJual.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
        ...
        barangAdapter = new InventoryBarangAdapter(this, inventoryModelList,1,this);
        rvBarangJual.setAdapter(barangAdapter);
    }
//    https://coderwall.com/p/zpwrsg/add-search-function-to-list-view-in-android
//    https://developer.android.com/training/search/setup.html
//    http://www.journaldev.com/12478/android-searchview-example-tutorial
    @Override
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_barang_jual);
        presenter = PresenterFactory.inventoryPresenter();
        presenter.attachView(this);
        findView();
        progressDialog.show();
        presenter.getInventoryForBarangJualBySellerID();
    }

    public static void showActivity(Context context) {
        Intent intent = new Intent(context, BarangJualActivity.class);
    ...
    public void deleteInventory(boolean isSuccess, String message) {
        presenter.getInventoryForBarangJualBySellerID();
        Toast.makeText(BarangJualActivity.this, message, Toast.LENGTH_LONG).show();
    }
    ...
    public void showDialogDelete(final InventoryModel inventoryModel) {
        new AlertDialog.Builder(BarangJualActivity.this)
